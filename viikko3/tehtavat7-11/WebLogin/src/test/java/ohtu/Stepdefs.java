...
public class Stepdefs {
    ...
    public void aValidUsernameAndPasswordAndMatchingPasswordConfirmationAreEntered(String username, String password, String confirmation) {
    ...
    @When("valid username {string} and valid password {string} but invalid password confirmation {string} are entered")
    public void validUsernameAndValidPasswordButInvalidPasswordConfirmationAreEntered(String username, String password, String confirmation) {
        createUserWith(username, password, confirmation);
    }
